...
export function AuthDynamicCanvas() {
  return (
    <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-zinc-50 dark:bg-zinc-950">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-40 dark:opacity-60 hidden md:flex" style={{ perspective: "1200px" }}>
        ...
        <motion.div
          ...
          className="absolute w-[360px] rounded-xl bg-[#0c0c0e] border border-white/10 shadow-2xl overflow-hidden"
        >
          ...
          <div className="p-5 font-mono text-[12px] leading-relaxed text-zinc-400">
             ...
             <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.5 }} className="mt-4 text-emerald-400 font-semibold">
               142 passed (18.4s)
             </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute w-[320px] rounded-xl bg-white/60 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200/50 dark:border-white/10 shadow-2xl p-6"
        >
          <div className="flex items-center justify-between mb-6">
            <div className="h-3 w-24 bg-zinc-200 dark:bg-zinc-700 rounded-full" />
            <div className="h-5 w-12 bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-[10px] font-bold rounded flex items-center justify-center">PASS</div>
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="relative">
                <div className="flex justify-between text-[10px] font-mono text-zinc-500 dark:text-zinc-400 mb-1">

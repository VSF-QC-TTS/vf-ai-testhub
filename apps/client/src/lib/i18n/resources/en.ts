export const en = {
  ...
  assertions: {
    ...
    disabled: "Disabled",
    scopes: {
      WHOLE_RESPONSE: "Whole response",
      FIELD: "Field path",
      COMPONENT: "Component",
      MULTI_FIELD: "Multi-field",
    },
    scopeDescriptions: {
      WHOLE_RESPONSE: "Check the whole raw response.",
      FIELD: "Check one JSONPath field, e.g. $.data.answer.",
      COMPONENT: "Check an extracted component such as answer or intent.",
      MULTI_FIELD: "Use several fields together, mostly for LLM rubric checks.",
    },
    groups: {
      TEXT: "Text",
      NUMBER: "Number",
      BOOLEAN: "Boolean / Existence",
      ARRAY: "Array",
      LLM: "LLM Rubric",
    },
    groupDescriptions: {
      TEXT: "Words, phrases, regex.",
      NUMBER: "Scores, counts, latency.",
      BOOLEAN: "True, false, exists.",
      ARRAY: "Length or contained item.",
      LLM: "Judged by rubric.",
    },
    types: {
      contains: "Contains",
      ...
      field_not_exists: "Field does not exist",
      array_length_greater_than: "Array length greater than",
      array_contains: "Array contains",
      llm_rubric: "LLM rubric",
    },
    typeDescriptions: {
      contains: "Actual text must include the expected text.",
      not_contains: "Actual text must not include the forbidden text.",
      equals: "Actual value must exactly match the expected text.",
      not_equals: "Actual value must be different from the expected text.",
      regex: "Actual text must match the regex pattern.",
      greater_than: "Actual number must be greater than the threshold.",
      less_than: "Actual number must be less than the threshold.",
      between: "Actual number must be inside an inclusive range.",
      is_true: "Actual value must be true.",
      is_false: "Actual value must be false.",
      field_exists: "Selected field must be present and non-null.",
      field_not_exists: "Selected field must be missing or null.",
      array_length_greater_than: "Array length must be greater than the threshold.",
      array_contains: "Array must contain the expected item.",
      llm_rubric: "Score response quality with reusable or case-specific criteria.",
    },
    arrayValueModes: {
      text: "Text",
      number: "Number",
    ...
    form: {
      ...
      steps: {
        scope: "Choose where to check",
        condition: "Choose the condition",
        expected: "Enter the expected value",
      },
      scope: "Scope",
      type: "Type",
      ...
      arrayValueMode: "Item type",
      arrayExpectedItem: "Expected item",
      noExpectedValueNeeded: "No expected value is needed for this condition. The runner checks the selected target directly.",
      ...
      severity: "Severity",
      enabled: "Enabled",
      scoringTitle: "Priority and scoring",
      ...
      validation: {
        ...
        componentRequired: "Target component is required when Scope is COMPONENT",
        fieldPathsRequired: "At least one field path is required when Scope is MULTI_FIELD",
        expectedValueRequired: "Expected value is required for this condition",
        expectedNumberRequired: "Enter a valid number",
        rangeRequired: "Enter both minimum and maximum values",
        rangeOrder: "Minimum must be less than or equal to maximum",
  ...
  report: {
    assertion: "Assertion",
    assertionReasonFallback: "Runner did not provide a detailed reason.",

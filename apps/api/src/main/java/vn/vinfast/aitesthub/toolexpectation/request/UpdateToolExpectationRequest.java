 ...
 * @since 6/21/2026
 */
@Schema(description = "Request object for updating a tool expectation")
public record UpdateToolExpectationRequest(
    @Schema(description = "Tool expectation type", example = "TOOL_MUST_BE_CALLED", nullable = true)

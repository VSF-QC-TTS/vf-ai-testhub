 ...
 * @since 6/21/2026
 */
@Schema(description = "Request object for updating a test case")
public record UpdateTestCaseRequest(
    ...
    @Schema(description = "User input sent to the chatbot", example = "VinFast VF 8 có mấy phiên bản?", nullable = true)
    String input,

...
public record ErrorResponse(
    @Schema(
            ...
            example = "https://vat.nghlong3004.me/errors/validation-error")
        String type,
    ...
    @Schema(
            ...
            example = "Validation failed for input data.")
        String detail,
    @Schema(
  ...
  private static final String TYPE_BASE_URL = "https://vat.nghlong3004.me/errors/";
  ...
  public ErrorResponse withInstance(String instance) {
    return new ErrorResponse(
        type, title, status, detail, instance, code, errors, retryAfterSeconds);
  }

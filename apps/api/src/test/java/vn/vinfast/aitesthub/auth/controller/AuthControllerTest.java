...
class AuthControllerTest {
  ...
  void loginReturnsAccessTokenBodyAndRefreshTokenCookie() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            header().string(HttpHeaders.SET_COOKIE, containsString("refresh_token=refresh-token")))
  ...
  void invalidRegisterReturnsProblemDetailsValidationError() throws Exception {
    mockMvc
        ...
        .andExpect(jsonPath("$.type").value("https://vat.nghlong3004.me/errors/validation-error"))
